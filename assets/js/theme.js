(function($) {
  ...
  (function () {
    ...
    $('.menu-panel__menu-link').click(function () {
      $('.header__menu').removeClass('header__menu_opened');
      hideMenu();
      button.removeClass('header__menu-button_cross');
  ...
  (function () {
    ...
    $('.top-menu__menu-item a[href^="#"], .menu-panel__menu-item a[href^="#"]').on('click',function (e) {
      e.preventDefault();
